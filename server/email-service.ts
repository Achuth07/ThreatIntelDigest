                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #0a0f1f; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);">
                  ...
                  <tr>
                    <td style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px 30px; text-align: center;">
                      <img src="https://i.ibb.co/bMR9GwhF/android-chrome-192x192.png" alt="WhatCyber Logo" style="width: 64px; height: 64px; margin-bottom: 20px; border-radius: 8px;">
                                                        ...
                                                        <tr>
                                                            <td valign="middle" style="padding-right: 12px;">
                                                                <a href="https://www.whatcyber.com/" style="text-decoration: none; border: 0;">
                                                                    <img src="https://i.ibb.co/bMR9GwhF/android-chrome-192x192.png" width="40" height="40" alt="Logo" style="display: block; border: 0; border-radius: 8px;">
                                                                </a>
                                                            </td>
                                                            <td valign="middle">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 40px; border-top: 1px solid #333333;">
                                            <tr>
                                                <td align="center" style="padding-top: 30px;">
                                                    <a href="https://www.whatcyber.com/" style="text-decoration: none; border: 0;">
                                                        <img src="https://i.ibb.co/bMR9GwhF/android-chrome-192x192.png" width="32" height="32" alt="WhatCyber" style="display: block; border: 0; border-radius: 6px; margin-bottom: 10px;">
                                                    </a>
