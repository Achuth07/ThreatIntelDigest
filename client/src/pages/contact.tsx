                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-whatcyber-teal to-whatcyber-green rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="mt-12 bg-white/5 backdrop-blur-lg p-6 rounded-2xl border border-white/10">
                    ...
                    <div className="flex gap-4">
                      <a 
                        ...
                        className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-[#666] hover:text-whatcyber-teal hover:bg-white/20 transition-all duration-300"
                      >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-whatcyber-teal focus:border-transparent transition-all duration-300"
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-whatcyber-teal to-whatcyber-green text-black font-semibold py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-whatcyber-teal/30 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
